    ...
    <nav className="bg-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16 items-center">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="text-2xl font-bold text-blue-600">MyBlogSite</Link>
          </div>

          {/* Middle: Menu (Desktop) */}
          <div className="hidden md:flex space-x-6">
            <Link href="/" className="text-gray-700 hover:text-blue-500">Home</Link>
            <Link href="/all-blogs" className="text-gray-700 hover:text-blue-500">All Blogs</Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-white px-4 pb-4 space-y-2">
          ...
          <Link href="/blogs" className="block text-gray-700 hover:text-blue-500">All Blogs</Link>
